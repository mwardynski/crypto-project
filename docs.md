...
The original problem is reduced to QSPs (Quadratic Span Programs) proposed by Gennaro, Gentry, Parno, and Raykova.

A QSP consists of multiple polynomials **v0...vi, w0...wj** over a field F and a target polynomial t.
